...
class ResturantMenu() : ContentProvider() {
    companion object {
        val PROVIDER_NAME = "com.example.MyApplication.ResturantMenu"
        ...
        val DATABASE_NAME = "Resturant"
        val STUDENTS_TABLE_NAME = "resturantmenu"
